...
<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0"
 ...
 <table id="Table_01"  style="border: solid 1px #AAA; padding: 5px; width: 650px; height: 350px;"
  align="center">
  ...
  <tr>
   <td colspan="3" class="cellContent">
    ...
    <br/>
    <p align="justify">We have received your message and we will get back to you on this shortly.</p>
    <br/> 
    <br/>
    <p>Thanks &amp; Regards,<br/>
    Team TaxiApp</p>
